...
public class NoticeDaoSqls {
	public static final String SELECT_ALL = "SELECT idx, category_id, notice_title, create_date "
										  + "FROM notice "
										  + "order by create_date DESC; ";

	public static final String SELECT_BY_CATEGORY = "SELECT idx, category_id, notice_title, create_date "
												  + "FROM notice "
